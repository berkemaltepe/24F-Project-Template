...
# Gets the top required skills for co-ops
...
# Gets top required skills of a specific skill type
...
# Gets top skills of a specific industry
...
# Gets the top student skills based on major
...
# Get average required weight for a skill
...
######### Getting Skill_Note Information ########
